/// Request-proof header builder (F1-02 / FS-01).
///
/// Attaches the proof headers required by the mobile auth endpoints
/// (docs/08 §4/§5): `X-Installation-Token`, `X-Proof-Timestamp`,
/// `X-Proof-Nonce`, `X-Device-Proof`.
///
...
/// Builds the request-proof headers for one outbound auth call.
///
